...
namespace InvoiceSystem.Models
{
    public class Database
    {
		...
		public Database()
        {
            // To change the database file source, change this string value:
            string sDatabaseSourceFileName = "InvoiceSystem.mdb";

            sConnectionString = @"Provider=Microsoft.Jet.OLEDB.4.0;Data source= " + Directory.GetCurrentDirectory() + "\\" + sDatabaseSourceFileName;
        }
